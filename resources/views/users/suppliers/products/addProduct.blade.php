                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="formGroupExampleInput" name="price_per_hour"
                                       placeholder="100" value="{{ old('price_per_hour') }}">
                            </div>
                        </div>
{{--                        <div class="col-6">--}}
{{--                            <div class="form-group">--}}
...
{{--                        </div>--}}
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="condition" class="form-control" id="formGroupExampleInput" cols="30" rows="5"> {{ old('condition') }} </textarea>
                    </div>

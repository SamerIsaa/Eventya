        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xs-12 add-form">
                    <h3>{{ trans('translation.editProduct') }}</h3>
                    ...
                    <form action="{{ route('product.update' , $product->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput" name="price_per_hour"
                                           placeholder="100" value="{{ $product->price_per_hour }}">
                                </div>
                            </div>
                            {{--                        <div class="col-6">--}}
                            {{--                            <div class="form-group">--}}
                        ...
                        <button type="submit" class="btn">{{ trans('translation.editProduct') }}</button>
                    </form>
                </div>

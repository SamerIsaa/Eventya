...
@section('content')
    ...
    <div class="new-request-page">
        <div class="container personal-request-container">
            <h3 class="use-policy-header text-center"><img class="right-line" src="{{ asset('userAssets/imgs/R.png') }}" alt="">{{ trans('translation.newOrders') }}<img
                ...
                @foreach($newOrders as $order)
                    ...
                    <div class="col-md-10 requested-product-info">
                        ...
                        <div>
                            ...
                            <div class="btn-div">
                                <button class="btn edit-btn" onclick="window.location = ' {{ route('order.accept' , $order->id) }}'">{{ trans('translation.acceptOrder') }}</button>
                                <button class="btn cancel-btn" onclick="window.location = ' {{ route('order.reject' , $order->id) }}'">{{ trans('translation.rejectionOrder') }}</button>
                            </div>
